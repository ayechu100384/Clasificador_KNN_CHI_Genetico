function [matrizResultados,clasesPredTst,infoDudososTst,marcasTst,clasesRealesTst] = aplicaKNNModificado(tipoKNN, k, KF )
    numParticiones = 5;
    abrirCarpeta = cd;
    ...
    for i = 1:numDatasets-2 %hay que quitar . y ..
        ...
        [ matConfusionTrain,clasesPredTr,infoDudososTr,marcasTr,clasesRealesTr ] = clasificar(clasificador, ejemplosTr, k, tipoKNN, 0,nClases,numAtr);%0 train
        [ matConfusionTest,clasesPredTst,infoDudososTst,marcasTst,clasesRealesTst ] = clasificar(clasificador, ejemplosTst, k, tipoKNN, 1,nClases,numAtr);%1 test                
